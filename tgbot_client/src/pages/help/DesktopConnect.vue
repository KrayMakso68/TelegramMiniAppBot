...
<template>
  ...
  <q-page class="tg-text overflow-auto">
    <tg-section label="Подключение на ПК">
      <div class="">
        <q-stepper
        ...
        >
          <q-step
            :name="1"
            title="Скачайте программу клиента на ваш ПК"
            icon="download"
            :done="step > 1"
          >
            <p>Для подключения к VPN на устройство необходимо установить клиент VPN.</p>
            ...
            <div class="p">Для Windows:</div>
            <q-btn
              label="Microsoft Store"
              type="a"
              href="https://apps.microsoft.com/detail/9PDFNL3QV2S5?hl=neutral&gl=RU&ocid=pdpshare"
              target="_blank"
              icon="open_in_new"
              class="tg-btn q-mb-sm"
            />

            <div class="p">Для MacOS:</div>
            <q-btn
              label="App Store"
              type="a"
            ...
            <q-img
              src="/images/help_desktop/install.png"
              spinner-color="gray"
          ...
          >
            ...
            <q-img
              src="/images/help_desktop/link_copy.png"
              spinner-color="gray"
            />
          ...
          >
            ...
            <q-img
              src="/images/help_desktop/add.png"
              spinner-color="gray"
              class="q-mt-sm q-mb-md"
            />
            ...
            <q-img
              src="/images/help_desktop/copy.png"
              spinner-color="gray"
              class="q-mt-sm q-mb-md"
            />
            ...
            <q-img
              src="/images/help_desktop/success.png"
              spinner-color="gray"
              class="q-mt-sm q-mb-md"
            />
          ...
          >
            ...
            <q-img
              src="/images/help_desktop/check.png"
              spinner-color="gray"
              class="q-mt-sm q-mb-md"
            />
